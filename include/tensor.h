...
namespace tgrad {
    ...
    public:
        ...
        static Tensor zeros(Shape shape, DType dtype = DType::Float32, Device device = Device::cpu());
        static Tensor ones(Shape shape, DType dtype = DType::Float32, Device device = Device::cpu());
        ...
        // Shape operations
        Tensor view(Shape new_shape) const; // fast; no copy reshape
        Tensor reshape(Shape new_shape) const; // slow; copies mem
        ...
        void print() const; // Tensor p = {2,3}; t.print();
